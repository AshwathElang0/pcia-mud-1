...
OUTPUT_CSV = os.path.join(RESULTS_DIR, 'samples_data_normalized_layout.csv')
OUTPUT_PLOT = os.path.join(RESULTS_DIR, 'normalized_median_a_star_scatter_layout.png')
SUMMARY_CSV = os.path.join(RESULTS_DIR, 'normalization_reference_stats_layout.csv')
...
plt.xlabel('Time (min)')
plt.ylabel('Normalized mean a*')
plt.title('Normalized Aggregated Circle Means by Time')
...
print(f'Saved normalization summary: {SUMMARY_CSV}')
